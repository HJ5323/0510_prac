        ...
        while (getline(file, line_name)) {
            ...
            if (name_in_file == name) {
                ...
                while (getline(file, line_name)) {
                    ...
                    stringstream ss_CheckName(line_name);
                    string CheckName_in_file;
                    ss_CheckName >> CheckName_in_file;

                    if (CheckName_in_file == newName) {
                ...
                if (!found) {
                    ...
                    file.seekg(0, ios::beg); // 현재 위치를 맨 앞으로 이동
